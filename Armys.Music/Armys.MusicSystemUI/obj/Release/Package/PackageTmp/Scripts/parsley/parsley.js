...
function (d) {
    var h = function (a) {
        this.messages = {
            ...
            type: {
                ...
                number: "请输入有效的数字.",
                digits: "请输入有效的数字.",
                dateIso: "请输入有效的日期 (2015-12-11).",
                alphanum: "请输入有效的字母或者数字.",
                phone: "请输入有效的电话号码."
            },
            notnull: "必填项.",
            notblank: "必填项.",
            ...
            checking: "已存在的数据",
            maxlength: "%s",
            rangelength: "此值应为 %s 和 %s 个字符之间.",
            mincheck: "您必须选择至少 %s 个.",
            maxcheck: "您必须选择 %s 个以下.",
            rangecheck: "您必须选择 %s 和 %s 之间.",
            equalto: "两次输入不一致."
        };
        this.init(a)
    };
    ...
    j.prototype = {
        ...
        validate: function (a) {
            ...
            if (this.options.listeners.onFieldValidate(this.element, this) || "" === b && !this.isRequired) return this.reset(),
            null;
        ...
        ulErrorManagement: function () {
            ...
            this.ulTemplate = d(this.options.errors.errorsWrapper).attr("id", this.hash).addClass("parsley-error-list text-danger")
        },
