...
$(function () {
    if ($("#fixednavbar").click(function () {
        ...
        $(".s-skin-1").removeClass("active-skin"),
        $(".s-skin-3").removeClass("active-skin"),
        ...
        $(this).addClass("active-skin"),
        $(".active-skin").addClass("skin1-active");
        $(".s-skin-0").removeClass("active-skin"),
        $(".s-skin-3").removeClass("active-skin"),
    ...
    if (localStorageSupport) {
        ...
        l.addClass(s);
        "" === s && $(".s-skin-0").addClass("active-skin"),
        "skin-1" === s && $(".s-skin-1").addClass("active-skin"),
        "skin-3" === s && $(".s-skin-3").addClass("active-skin");
    }
});